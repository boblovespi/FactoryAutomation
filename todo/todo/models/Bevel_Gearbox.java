 ...
 */
public class Bevel_Gearbox extends ModelBase {
    ...
    public Bevel_Gearbox() {
        ...
        this.axel_out = new ModelRenderer(this, 34, 56);
        this.axel_out.setRotationPoint(0.0F, 16.0F, 0.0F);
        this.axel_out.addBox(2.5F, -1.0F, -0.95F, 6, 2, 2, 0.0F);
        ...
        this.axel_in = new ModelRenderer(this, 34, 62);
        this.axel_in.setRotationPoint(0.0F, 16.0F, 0.0F);
        this.axel_in.addBox(-0.95F, -1.0F, -8.5F, 2, 2, 6, 0.0F);
