...
public class ToolMaterial implements Tier
{
	...
	public static Tier flintMaterial = TierSortingRegistry.registerTier(new ToolMaterial(WOOD, 20, 4.5f, 1.5f, 2, () -> Ingredient.of(Items.FLINT)),
	...
	public static Tier bronzeMaterial = TierSortingRegistry.registerTier(new ToolMaterial(BRONZE, 600, 5.0F, 2.0F, 12, () -> Ingredient.of(FATags.ForgeItemTag("ingots/bronze"))),
