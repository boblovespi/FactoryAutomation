 ...
 */
package boblovespi.factoryautomation.common.guidebook.category;
...
public class GuidebookCategory implements Comparable<GuidebookCategory> {

	private static int count = 0;

	public final String unlocalizedName;
	public final List<GuidebookEntry> entries = new ArrayList<>();
	 ...
	 */
	public GuidebookCategory(String unlocalizedName) {
	 ...
	 * by insertion order.
	 */
	public GuidebookCategory setPriority(int priority) {
	...
	public GuidebookCategory setIcon(ResourceLocation icon) {
		this.icon = icon;
		return this;
	}
	...
	@Override
	public int compareTo(@Nonnull GuidebookCategory category) {
